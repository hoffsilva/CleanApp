//
//  AddAccountUseCaseImpTests.swift
//  AddAccountUseCaseImpTests
//
...
class AddAccountUseCaseImpTests: XCTestCase {
    ...
    func test_add_should_call_httpClient_with_correct_url() {
        ...
        let sut = AddAccountUseCaseImp(url: url!, httpClient: httpClient)
...
extension AddAccountUseCaseImpTests {
    
    func createSUT(with httpClient: HttpClientSpy, file: StaticString = #file, line: UInt = #line) -> AddAccountUseCaseImp {
        let sut = AddAccountUseCaseImp(url: TestTools.createUrl(), httpClient: httpClient)
